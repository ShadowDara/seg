...
fn view(config: &AppConfig) {
    ...
    let _ = write!(
        file,
        "\n*File generated by linksaver from seg* - [https://samengine.vercel.app/packages](https://samengine.vercel.app/packages)\n"
    );

    println!("Created File - Use parseMarkdown from samengine to make it into a nice html file.")
}
